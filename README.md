...
В проекте настроено авторазвёртывание через GitHub Pages и GitHub Actions. Проект доступен по: [ссылке](https://vershininnv.github.io/sevtech-test/). Либо Вы можете развернуть проект локально. Для этого следуйте шагам ниже.
# 1. Скачивание проекта

Скопируйте в командную строку, либо воспользуйтесь ПО для работы с репозиториями. **Обратите внимание, что для локального развёртывания проект должен быть в ветке: master.**
